...
export default {
  ...
  created (){
    ...
    let self = this
    // 对路由变化作出响应...
    this.$store.dispatch("getTime",{musicName:"lookWhat"}).then((res) => {
      console.log(res)
      let xData = []
      let yData = []
    ...
    this.$store.dispatch("getTime",{musicName:"chendu"}).then((res) => {
      console.log(res)
      let xData = []
      let yData = []
      for (var i = 0; i < res.length-2; i++) {
    ...
    this.$store.dispatch("getTime",{musicName:"qt"}).then((res) => {
      console.log(res)
      let xData = []
      let yData = []
    ...
    this.$store.dispatch("getTime",{musicName:"sugar"}).then((res) => {
      console.log(res)
      let xData = []
      let yData = []
    ...
    this.$store.dispatch("getTime",{musicName:"waitYou"}).then((res) => {
      console.log(res)
      let xData = []
      let yData = []
      for (var i = 0; i < res.length; i++) {
